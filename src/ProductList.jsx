...
function ProductList() {
    ...
    const contains = (item) => {
        return cartItems.some((inList) => item.name === inList.name);
    }
                    ...
                    <div className="product-list"> 
                        {category.plants.map((plant, plantIndex) => (
                            <div className="product-card" key={plantIndex}>
                                ...
                                <button style={{backgroundColor: contains(plant) ? "gray" : "#45a049"}} disabled={contains(plant)} className="product-button" onClick={() => handleAddToCart(plant)}>
                                    {contains(plant) ? 'Added to Cart' : "Add to Cart"}
                                </button>
                            </div>
                        ))}
                    </div>
